...
function updateTable(data) {
    // Para asegurarse que realmente hemos recuperado un array de datos. Porque si no, el foreach nos fallaría
    let tbody = document.querySelector('tbody')

    // Habría que buscar la manera de borrar los objetos con removeChild
    tbody.innerHTML = ""
    ...
    data.forEach(gato => {
        ...
        // Si tiene fecha de alta, comprobamos si es anterior a la fecha de ingreso para informar al equipo
